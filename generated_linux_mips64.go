...
// PtraceGetRegsMips is an alias of golang.org/x/sys/unix.PtraceGetRegsMips, wrapped to automatically retry on EINTR.
func PtraceGetRegsMips(pid int, regsout *unix.PtraceRegsMips) error {
	var (
		_v0 error
	)
	for {
		_v0 = unix.PtraceGetRegsMips(pid, regsout)
		if _v0 != syscall.EINTR {
			break
		}
	}
...
// PtraceSetRegsMips is an alias of golang.org/x/sys/unix.PtraceSetRegsMips, wrapped to automatically retry on EINTR.
func PtraceSetRegsMips(pid int, regs *unix.PtraceRegsMips) error {
	var (
		_v0 error
	)
	for {
		_v0 = unix.PtraceSetRegsMips(pid, regs)
		if _v0 != syscall.EINTR {
			break
		}
	}
...
// PtraceGetRegsMips64 is an alias of golang.org/x/sys/unix.PtraceGetRegsMips64, wrapped to automatically retry on EINTR.
func PtraceGetRegsMips64(pid int, regsout *unix.PtraceRegsMips64) error {
	var (
		_v0 error
	)
	for {
		_v0 = unix.PtraceGetRegsMips64(pid, regsout)
		if _v0 != syscall.EINTR {
			break
		}
	}
...
// PtraceSetRegsMips64 is an alias of golang.org/x/sys/unix.PtraceSetRegsMips64, wrapped to automatically retry on EINTR.
func PtraceSetRegsMips64(pid int, regs *unix.PtraceRegsMips64) error {
	var (
		_v0 error
	)
	for {
		_v0 = unix.PtraceSetRegsMips64(pid, regs)
		if _v0 != syscall.EINTR {
			break
		}
	}
